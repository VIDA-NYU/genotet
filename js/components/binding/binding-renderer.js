...
var extObject = {
  initialize: function(htmlid, width, height) {
    ...
    this.height = height - manager.headerHeight;
  ...
  prepareData: function(){  // get xmin, xmax, etc. called when binding data (gene,chr) changed
  ...
  initFocus: function(xl, xr){  // only called by the loader
    this.focusleft = xl;
    this.focusright = xr;
  },
  ...
  selectOverviewStart: function(d){
  ...
  updateCursorline: function(layoutX, valueX){
  ...
  loadBindingLayout: function(acrossChr){
...
var BindingRenderer = HistogramRenderer.extend(extObject);
