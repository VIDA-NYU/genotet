...
var extObject = {
  ...
  uiFilterSelect: function(cmd, type){
  ...
  reloadTable: function(){ // called from global
...
var TableRenderer = Renderer.extend(extObject);
