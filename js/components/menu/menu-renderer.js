...
var extObject = {
  render: function() {
    ...
    $(jqnode).find("#close").click( function(){ closeAllViews(); createMenu(); });

    $(jqnode).find("#preset_default").click( function(){ manager.loadPreset("default"); });
    $(jqnode).find("#preset_binding_3").click( function(){ manager.loadPreset("binding_3"); });
    $(jqnode).find("#preset_binding_4").click( function(){ manager.loadPreset("binding_4"); });
    $(jqnode).find("#preset_binding_6").click( function(){ manager.loadPreset("binding_6"); });
    $(jqnode).find("#preset_expmat").click( function(){ manager.loadPreset("expmat"); });
    $(jqnode).find("#preset_network").click( function(){ manager.loadPreset("network"); });

    $(jqnode).find("#help").click( function(){ window.open('help.html'); } );
  },
